...
\begin{document}
    ...
    \section{Temperature Induced Unfolding Transitions}
        ...
        \subsection*{Analysis}
            ...
            The transition midpoints are plotted in the two plots.
    \pagebreak
    ...
    \section{Michaelis-Menten Kinetics}
        ...
        \subsection*{Measurements}
            ...
            \subsection*{Analysis}
                The Michaelis-Menten plot (Figure~\ref{fig:mm_plot}(a)) could be plotted from the reaction rates 
                ...
                rate $V_{max}$ and the Michaelis constant $K_m$.\\
                The result for $V_{max}$ = 0.0116 µM/s and for $K_m$ = 0.1942 µM, respectively.
